...
const DEFAULT_CONFIG = {
  bot: {
    ...
    commands: {
      defaultPrefixes: ['+Ducz', '+d', '+p', '+play', '+tocar', '+skip', '+pular', '+stop', '+parar', '+sair', '+leave', '+i', '+fav', '+efeito', '+efeitos', '+effect', '+ef', '+fila', '+queue', '+remove', '+rm', '+playlist', '+pl', '+clear', '+help', '+ajuda', '+prefix'],
    },
  },
  sources: {
    resolution: {
